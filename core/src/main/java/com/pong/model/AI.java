...
public class AI {
    public float update(float rightPaddleY, float paddleSpeed, float deltaTime, float ballY, float ballVelocityX, int ballSize, int paddleHeight, int screenHeight) {
